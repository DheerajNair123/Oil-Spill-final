                            ...
                            <table class="table align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-chart-bar"></i> Severity</th>
                                ...
                                <tbody>
                                    {% for alert in alerts %}
                                        <tr>
                                            <td>{{ alert.detection_time.strftime('%Y-%m-%d %H:%M') if alert.detection_time else '-' }}</td>
                                            <td>{{ alert.location_label or 'Unknown' }}</td>
                                            <td>
                                                {% if alert.severity == 'high' %}
                                                    <span class="badge-severity-high">{{ alert.severity.upper() }}</span>
                                                {% elif alert.severity == 'medium' %}
                                                    <span class="badge-severity-medium">{{ alert.severity.upper() }}</span>
                                                {% else %}
                                                    <span class="badge-severity-low">{{ alert.severity.upper() }}</span>
                                                {% endif %}
                                            </td>
                                            <td>{{ alert.status }}</td>
                                        </tr>
            ...
            <div class="col-lg-4">
                <div class="section-card">
                    ...
                    <form method="POST" action="{{ url_for('create_user') }}">
                        ...
                        <div class="mb-3">
                            {{ create_user_form.username(class="form-control", placeholder="Username", autocomplete="off") }}
                        </div>
                        <div class="mb-3">
                            {{ create_user_form.email(class="form-control", placeholder="Email", autocomplete="off") }}
                        </div>
                        <div class="mb-3">
                            {{ create_user_form.role(class="form-control") }}
                        </div>
                        <div class="mb-3">
                            {{ create_user_form.password(class="form-control", placeholder="Temporary Password", autocomplete="off") }}
                        </div>
